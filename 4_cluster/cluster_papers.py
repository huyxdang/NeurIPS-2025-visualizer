...
def cluster_papers(
    input_file: str = "4_cluster/data/neurips_2025_papers_with_umap.parquet",
    output_file: str = "4_cluster/data/neurips_2025_papers_with_clusters.parquet",
    n_clusters: int = None,
    auto_k: bool = True
):
    """
...
Recommended k values:
  ...
  - Large dataset (5000+): k=20-40
    ...
    parser.add_argument('--input', default='4_cluster/data/neurips_2025_papers_with_umap.parquet',
                       help='Input parquet file with UMAP coordinates')
    parser.add_argument('--output', default='4_cluster/data/neurips_2025_papers_with_clusters.parquet',

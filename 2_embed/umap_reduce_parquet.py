...
def main(input_file=None, output_file=None):
    ...
    if embeddings_count == 0:
        print("❌ Error: No embeddings found. Run embed_local.py first.")
        sys.exit(1)
...
Examples:
  ...
  python umap_reduce_parquet.py input.parquet -o output.parquet
    ...
    parser.add_argument('input', nargs='?', 
                       help='Input Parquet file with embeddings (default: data/neurips_2025_papers_with_embeddings.parquet)')
    parser.add_argument('-o', '--output', 
                       help='Output Parquet file (default: data/neurips_2025_papers_with_umap.parquet)')
